...
Please note: a full version of this vignette (with gif documentation) is available to download [here](https://github.com/RamiKrispin/MLstudio/blob/master/vignettes/my-vignette.html)
